function b = AssembleVector(points, edges, triangles,eq, pde, W, time)
...
for triangle = triangles
  ...
  for p = midpoints
    ...
    for i = 1:3
      ...
      integral = feval(pde, 0, v, w, [0;0], dv, dw, dx, 0, x, d, time, eq) / 3.0;
 ...
 if(edge(2:3) ==0)
  ...
  for p = gausspoints
    ...
    for i = 1:2
      ...
      integral = feval(pde, 0, v, w, [0;0], [0;0], dw, 0, ds, x, d, time, eq,0,0,0) / 2.0;
      b(nodes(i)) = b(nodes(i)) + integral;
