...
function [p,e,t, GLnode, npart,point_exact,triangle_exact,node_gamma,node_interior,...
    node_interfacewhole,node_remainingwhole,R,D] = ExtractGmshPart_puff(filename)
...
% Node renaming to construct stiffness matrix independantly
...
[node_gamma,node_interior,node_interfacewhole,node_remainingwhole,R,D]... 
