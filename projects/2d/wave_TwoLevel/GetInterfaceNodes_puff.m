...
function [node_gamma,node_interior,node_interfacewhole,node_remainingwhole,R,D,node_corner,node_remaining,...
 node_c,node_r,Rc,Rr,Bc,node_gamma_OG,node_interior_OG,node_corner_OG,node_remaining_OG]= GetInterfaceNodes_puff(numpartition,partID,p_part,triangles,edges)
...
[Rc] = GetRestrictionMatrix(numpartition,node_interface_part,node_corner_part,1);

[Rr] = GetRestrictionMatrix(numpartition,node_interface_part,node_remaining_part,1);


[Bc] = GetRestrictionMatrix(numpartition,node_corner,node_corner_part,0);

% Getting Restriction Matrix before renaming

[R] = GetRestrictionMatrix(numpartition,node_interface,node_interface_part,0);
